<%@ Page Title="" Language="C#" MasterPageFile="~/User/Default.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="ShoeMartProject.User.Registration" %>
        ...
        <div class="container">
            <div class="heading-container">
                <div class="align-self-end">
                    ...
                    <asp:Label ID="lblHeadingMsg" runat ="server" Text="<h2> User Registration </h2>"></asp:Label>
            </div>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form_container">
                        ...
                        <div> 
                            <asp:RequiredFieldValidator ID="rfvPostCode" runat="server" ErrorMessage="Post/Zip Code Is Required"
                                ...
                                ></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="revPostCode" runat="server" ErrorMessage="Post/ Zip Code must have 10 digits"
                                ControlToValidate="txtPostCode" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                            ...
                            <asp:TextBox ID="txtPostCode" runat="server" CssClass="form-control" placeholder="Enter Postcode"
                                ToolTip="Pose/Zip Code"></asp:TextBox>
                        </div>
                        
                        <div> 
                            <asp:FileUpload ID="fuUserImage" runat="server" ToolTip="User Image" CssClass="form-control"
