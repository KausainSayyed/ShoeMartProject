<%@ Page Title="" Language="C#" MasterPageFile="~/User/Default.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="ShoeMartProject.User.Cart" %>
                ...
                <FooterTemplate>
                    ...
                    <tr>
                        <td colspan="2" class="continue__btn">
                            <a href="Home.aspx" class="btn btn-info"><i class="fa fa-arrow-circle-left mr-2">&nbsp&nbsp&nbsp Continue Shopping</i></a>
                        </td>
                        <td>
                            <asp:LinkButton ID="lbUpdateCart" runat="server" CommandName="updateCart" CssClass="btn btn-warning">
                                <i class="fa fa-refresh mr-2">&nbsp&nbsp&nbsp Update Cart</i>
                            </asp:LinkButton>
                        </td>
                        <td>
                            <asp:LinkButton ID="lbCheckout" runat="server" CommandName="checkout" CssClass="btn btn-success">
                                Checkout &nbsp&nbsp&nbsp&nbsp<i class="fa fa-arrow-circle-right mr-2"></i>
                            </asp:LinkButton>
                        </td>
                    </tr>
                    </tbody>
