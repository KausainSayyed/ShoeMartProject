<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="ShoeMartProject.Admin.Product" %>
<%@ Import Namespace="ShoeMartProject" %>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    ...
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                                                        ErrorMessage="Quantity is in Positive Integer" ForeColor="Red" Display="Dynamic" 
                                                        SetFocusOnError="true" ControlToValidate="txtPrice"
                                                    ...
                                                    <asp:Repeater ID="rProduct" runat="server" OnItemCommand ="rProduct_ItemCommand" 
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <img alt=""height="120px" width="120px" src=" <%# Utils.GetImageUrl( Eval("ImageUrl")) %> "/>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lknEdit" Text="Edit" runat="server" CssClass="badge badge-primary"
                                                                        CommandArgument='<%# Eval("ProductId") %>' CommandName="edit" CausesValidation="false">
                                                                        <i class="ti-pencil"></i></asp:LinkButton>
                                                                    
                                                                    <asp:LinkButton ID="lknDelete" Text="Delete" runat="server" CommandName="delete" CssClass="badge bg-danger"
